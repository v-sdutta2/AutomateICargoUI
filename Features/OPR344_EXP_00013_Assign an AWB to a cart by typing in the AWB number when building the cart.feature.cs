...
#line hidden
        ...
        [NUnit.Framework.TestAttribute()]
        [NUnit.Framework.DescriptionAttribute("Type in the AWB number Assign to a cart by when building the cart")]
        [NUnit.Framework.TestCaseAttribute("SEA", "JFK", "2", "59", "PlannedShipment", "CART", "675", null)]
        public virtual void TypeInTheAWBNumberAssignToACartByWhenBuildingTheCart(string origin, string destination, string piece, string weight, string aWBSectionName, string cartType, string flightNumber, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Type in the AWB number Assign to a cart by when building the cart", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 43
this.ScenarioInitialize(scenarioInfo);
#line hidden
            bool isScenarioIgnored = default(bool);

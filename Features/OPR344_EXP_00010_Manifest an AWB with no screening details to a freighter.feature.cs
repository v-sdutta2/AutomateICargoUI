...
namespace iCargoUIAutomation.Features
{
    ...
    public partial class OPR344_EXP_00010_ManifestAnAWBWithNoScreeningDetailsToAFreighterFeature
    {
...
#line 1 "OPR344_EXP_00010_Manifest an AWB with no screening details to a freighter.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features", "OPR344_EXP_00010_Manifest an AWB with no screening details to a freighter", "Manifest a Shipment as a CGO or CGODG user", ProgrammingLanguage.CSharp, ((string[])(null)));
        ...
        [NUnit.Framework.DescriptionAttribute("Create and accept an AWB for a known shipper booked on freighter flights without " +
            "screening details")]
        ...
        public virtual void CreateAndAcceptAnAWBForAKnownShipperBookedOnFreighterFlightsWithoutScreeningDetails(
                    string agentCode, 
                    string shipperCode, 
                    ...
                    string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Create and accept an AWB for a known shipper booked on freighter flights without " +
                    "screening details", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 6
...
#line hidden
        ...
        [NUnit.Framework.TestAttribute()]
        [NUnit.Framework.DescriptionAttribute("Manifest an AWB with no screening details to a freighter")]
        [NUnit.Framework.TestCaseAttribute("SEA", "ANC", "2", "59", "PlannedShipment", "CART", null)]
        public virtual void ManifestAnAWBWithNoScreeningDetailsToAFreighter(string origin, string destination, string piece, string weight, string aWBSectionName, string cartType, string[] exampleTags)
        {
            ...
            argumentsOfScenario.Add("cartType", cartType);
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Manifest an AWB with no screening details to a freighter", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 41
this.ScenarioInitialize(scenarioInfo);
#line hidden
            bool isScenarioIgnored = default(bool);

...
#line hidden
        ...
        [NUnit.Framework.TestCaseAttribute("10763", "10763", "10763", "ANC", "OME", "GENERAL", "None", "0316", "None", "None", "2", "59", "CC", "None", "CART", null)]
...
#line hidden
        ...
        [NUnit.Framework.DescriptionAttribute("Manifest an AWB that has not been screened and came inbound via freighter to a PA" +
            "X flight")]
        [NUnit.Framework.TestCaseAttribute("ANC", "OME", "155", "2", "59", "LyingList", "CART", null)]
        public virtual void ManifestAnAWBThatHasNotBeenScreenedAndCameInboundViaFreighterToAPAXFlight(string origin, string destination, string flightNumber, string piece, string weight, string aWBSectionName, string cartType, string[] exampleTags)
        {

...
#line hidden
        ...
        [NUnit.Framework.DescriptionAttribute("Booking Unknown Shipper on a pax flight")]
        [NUnit.Framework.CategoryAttribute("OPR344")]
        [NUnit.Framework.TestCaseAttribute("ASQXGUEST", "C1001", "10763", "SEA", "ANC", "GENERAL", "None", "0316", "None", "None", "2", "59", "CC", "None", "CART", null)]
        public virtual void BookingUnknownShipperOnAPaxFlight(
                    string agentCode, 
                    ...
                    string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Booking Unknown Shipper on a pax flight", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 6
...
#line hidden
        ...
        [NUnit.Framework.TestAttribute()]
        [NUnit.Framework.DescriptionAttribute("Manifest an AWB for Unknown shipper")]
        [NUnit.Framework.TestCaseAttribute("SEA", "ANC", "2", "59", "PlannedShipment", "CART", null)]
        public virtual void ManifestAnAWBForUnknownShipper(string origin, string destination, string piece, string weight, string aWBSectionName, string cartType, string[] exampleTags)
        {
            ...
            argumentsOfScenario.Add("cartType", cartType);
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Manifest an AWB for Unknown shipper", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 42
this.ScenarioInitialize(scenarioInfo);
#line hidden
            bool isScenarioIgnored = default(bool);

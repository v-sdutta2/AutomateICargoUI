...
#line hidden
        ...
        [NUnit.Framework.TestCaseAttribute("SEA", "ANC", "GENERAL", "None", "0316", "None", "None", "2", "59", "CC", "None", "CART", null)]
        public virtual void CreateAnAWBInLTE001ThatHasPiecesThatFailScreening(string origin, string destination, string productCode, string sCC, string commodity, string shipmentDescription, string serviceCargoClass, string piece, string weight, string chargeType, string modeOfPayment, string cartType, string[] exampleTags)
        {

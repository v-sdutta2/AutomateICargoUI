...
#line hidden
        ...
        [NUnit.Framework.TestCaseAttribute("ANC", "LAX", "GENERAL", "None", "0316", "None", "None", "2", "59", "PP", "CREDIT", "CART", null)]
        public virtual void CreateAPPAWBInLTE001ForAKnownShipper(string origin, string destination, string productCode, string sCC, string commodity, string shipmentDescription, string serviceCargoClass, string piece, string weight, string chargeType, string modeOfPayment, string cartType, string[] exampleTags)
        {

...
#line hidden
        ...
        [NUnit.Framework.TestCaseAttribute("SEA", "JFK", "2", "59", "PlannedShipment", "CART", "675", "1", null)]
        public virtual void SplitAnAWBInOPR344AndManifestSplitPiecesToAFlight(string origin, string destination, string piece, string weight, string aWBSectionName, string cartType, string flightNumber, string splitPieces, string[] exampleTags)
        {

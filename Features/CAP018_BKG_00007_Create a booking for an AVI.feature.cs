...
#line hidden
        ...
        [NUnit.Framework.TestCaseAttribute("SEA", "ANC", "18-Apr-2024", "PET CONNECT", "9730", "2", "50", "18-Apr-2024", "AS61", "PP", null)]
        public virtual void ICargoLoginAndCreateNewAVIShipment(string origin, string destination, string shippingDate, string productCode, string commodity, string piece, string weight, string flightDate, string flightNo, string chargeType, string[] exampleTags)
        {
